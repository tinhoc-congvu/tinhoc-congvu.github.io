...
function checkCookie(userCurrent, idCourse) {
    ...
    if (user != "" && user == userCurrent) {
        ...
        var linkRunToCourse = "https://tinhoc-congvu.github.io/course.html?id=" + idCourse;
...
function runToCourse(idCourse, yourUsername){
    ...
    var linkRunToCourse = "https://tinhoc-congvu.github.io/course.html?id=" + idCourse + "&user=" + yourUsername;
